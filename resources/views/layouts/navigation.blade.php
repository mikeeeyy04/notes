<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('notes')" :active="request()->routeIs('notes')" class="text-decoration-none">
                {{ __('Notes') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('employees')" :active="request()->routeIs('employees')" class="text-decoration-none">
                {{ __('Employees') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('departments')" :active="request()->routeIs('departments')" class="text-decoration-none">
                {{ __('Departments') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('records.index')" :active="request()->routeIs('records')" class="text-decoration-none">
                {{ __('Records') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('attendance.index')" :active="request()->routeIs('attendance')" class="text-decoration-none">
                {{ __('Attendance') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('payroll.index')" :active="request()->routeIs('payroll')" class="text-decoration-none">
                {{ __('Payroll') }}
            </x-responsive-nav-link>
        </div>
